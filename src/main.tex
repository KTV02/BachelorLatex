...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{other_pictures/Technologien.png}
        \caption{Grafische Übersicht über unsere genutzten Technologien}
        \label{technologien_ueberblick}
    \end{figure}
