...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    TryHackMe konnte hier noch nicht weiterhelfen.
    ...
    Die Datei \glqq secretpath.php\grqq\ enthielt eine Umleitung auf \glqq /login.php?init=true\grqq, um die Login-Seite anzuzeigen.
    ...
    Somit war die Login-Seite nur über \glqq secretpath.php\grqq\ erreichbar (oder man kannte den genauen Parameter und setzte ihn manuell).
