...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Dies ermöglicht es, das nach jedem Aufruf des Zielsystems durch unbedarfte Nutzer, das schädliche \ac{xss} Skript ausgeführt wird.
    Beliebte Beispiele hierfür sind Forenbeiträge, Kommentare oder Datenbankeinträge.
    ...
    tritt in den Versionen 6.9.3-10 und 7.x vor 7.0.1-1 von ImageMagick auf.
    Durch diese ist es möglich Schadcode gemeinsam mit einem Bild hochzuladen und serverseitig auszuführen.
