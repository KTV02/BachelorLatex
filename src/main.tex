...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{enumerate}[leftmargin=2.5cm]
        ...
        \item[3] \textit{bash scan.sh}  anwenden, um die Datei und somit das Skript auszuführen.
    \end{enumerate}
    ...
    \begin{figure}[H]
        ...
        \caption{Scan auf Schwachstellen mit dem einem Skript (\ref{lst:schwachstellentestSkript}).
